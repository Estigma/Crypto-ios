...
extension AssetsApiClient: DependencyKey {
    static var liveValue: AssetsApiClient {
        let db = Firestore.firestore().collection("favourities")
        let urlSession = URLSession.shared
        let apikey = "6b485c584d692e1a35d6025d8fae446d0458f1ff80c1722ab2173b6f9ae99cea"
        let baseUrl = "https://rest.coincap.io/v3"
            ...
            fetchAsset: { assetId in
                ...
                let(data, _) = try
                await urlSession.data(for: URLRequest(url: url))
